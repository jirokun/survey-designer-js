...
class EnquetePreviewApp extends Component {
  ...
  render() {
    const { survey, runtime, restart, setCurrentNodeId } = this.props;
    ...
    return (
      <div>
        ...
        <div className="preview-answer">
          <div className="title">回答値</div>
          <div className="go-to-specified-page">
            <p><label>
              <select value={runtime.getCurrentNodeId()} onChange={e => setCurrentNodeId(e.target.value)}>
...
const actionsToProps = dispatch => ({
  ...
  setCurrentNodeId: specifiedNodeId => dispatch(Actions.setCurrentNodeId(specifiedNodeId)),
