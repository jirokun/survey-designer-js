...
export const PersonalQuestionItemRecord = Record({
  _id: null,                                  // ID
...
export default class PersonalQuestionItemDefinition extends PersonalQuestionItemRecord {
  static create(index, rowType, label, isOptional, displayTypeId, displayTypeCandidates) {
    ...
    return new PersonalQuestionItemDefinition({
      _id: cuid(),
      index,
      rowType,
      isOptional,
