...
export default class PersonalInfoItemDisplayTypeDefinition extends PersonalInfoItemDisplayTypeRecord {
  static create(displayType) {
    ...
    return new PersonalInfoItemDisplayTypeDefinition({ _id: displayType.id, label: displayType.label, personalItemFields: List(fieldDefinitions) });
  }
