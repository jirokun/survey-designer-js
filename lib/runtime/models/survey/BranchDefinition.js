...
export default class BranchDefinition extends BranchDefinitionRecord {
  ...
  static createEvaluateChildConditionClosure(answers, allOutputDefinitionsMap, replaceUtil) {
    return (childCondition) => {
      ...
      const value = replaceUtil.name2Value(childCondition.getValue());
  ...
  evaluateConditions(answers, allOutputDefinitionsMap, replaceUtil) {
    const evaluateChildConditionClosure = BranchDefinition.createEvaluateChildConditionClosure(answers, allOutputDefinitionsMap, replaceUtil);
