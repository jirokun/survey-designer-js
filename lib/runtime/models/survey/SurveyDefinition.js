...
import CssUrlDefinition from './survey/CssUrlDefinition';
...
export default class SurveyDefinition extends SurveyDefinitionRecord {
  ...
  updateCssUrls(cssRuntimeUrls, cssPreviewUrls) {
    return this.merge({
      cssRuntimeUrls: fromJS(cssRuntimeUrls),
      cssPreviewUrls: fromJS(cssPreviewUrls),
    });
  }
  ...
  hasCssUrls() {
    ...
    return (runtimeUrls != null && runtimeUrls.size >= 1) || (previewUrls != null && previewUrls.size >= 1);
  }
}
