...
export default class SurveyDefinition extends SurveyDefinitionRecord {
  ...
  /** cssUrlsの更新 */
  updateCssUrls(cssRuntimeUrls, cssPreviewUrls) {
    return this.merge({ cssRuntimeUrls, cssPreviewUrls });
  }
  ...
  hasCssUrls() {
    ...
    const previewUrls = this.getCssRuntimeUrls();
    return (runtimeUrls && runtimeUrls.size >= 1) || (previewUrls && previewUrls.size >= 1);
  }
}
