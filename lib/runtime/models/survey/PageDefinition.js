...
export default class PageDefinition extends PageDefinitionRecord {
  ...
  /** itemの属性の更新 */
  updateItemAttribute(questionId, itemId, attributeName, value) {
    const questionIndex = this.findQuestionIndex(questionId);
    const itemIndex = this.findItemIndex(questionId, itemId);
    return this.setIn(['questions', questionIndex, 'items', itemIndex, attributeName], value);
  }

  /** subItemの属性の更新 */
  updateSubItemAttribute(questionId, itemId, attributeName, value) {
    const questionIndex = this.findQuestionIndex(questionId);
    const itemIndex = this.findSubItemIndex(questionId, itemId);
    return this.setIn(['questions', questionIndex, 'subItems', itemIndex, attributeName], value);
  }
