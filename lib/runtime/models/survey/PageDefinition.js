    ...
    Object.keys(value).forEach((itemId) => {
      ...
      newState = newState.updateIn(['questions', questionIndex, 'items', itemIndex, 'visibilityCondition'], visibilityCondition => (
        visibilityCondition === null ?
          VisibilityConditionDefinition.create(survey, outputDefinitions, value[itemId], replacer)
          : visibilityCondition.updateProperties(survey, outputDefinitions, value[itemId], replacer)
      ));
    });
    return newState;
  }
