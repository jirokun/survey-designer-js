...
class EnqueteRuntimeApp extends Component {
  componentDidMount() {
    ...
    PlainComponents.attachNumericInput(this.rootEl);
    PlainComponents.attachSumCols(this.rootEl);
    PlainComponents.attachSumRows(this.rootEl);
    PlainComponents.attachMatrixAdditionalInput(this.rootEl);
    PlainComponents.attachSchedule(this.rootEl);
  }
