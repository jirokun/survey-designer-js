...
/** funcが完了するまでexecutingをtrueにする */
export function executeNextTick(dispatch, func) {
  dispatch({ type: C.CHANGE_EXECUTING, executing: true });
  setTimeout(() => {
    func();
    dispatch({ type: C.CHANGE_EXECUTING, executing: false });
  }, 0);
}
