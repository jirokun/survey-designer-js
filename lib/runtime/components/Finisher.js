...
class Finisher extends Component {
  ...
  executePostAnswer(force) {
    ...
    asyncPostAnswer(runtime.getAnswers().toJS(), finisher.isComplete(), options);
  }
...
const actionsToProps = dispatch => ({
  ...
  asyncPostAnswer: (answers, isComplete, options) =>
    Actions.asyncPostAnswer(dispatch, answers, isComplete, options),
});
