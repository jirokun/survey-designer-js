...
class Finisher extends Component {
  ...
  executePostAnswer(force) {
    ...
    asyncPostAnswer(survey, runtime.getAnswers().toJS(), finisher.isComplete(), options);
  }
...
const actionsToProps = dispatch => ({
  ...
  asyncPostAnswer: (survey, answers, isComplete, options) =>
    Actions.asyncPostAnswer(dispatch, survey, answers, isComplete, options),
});
