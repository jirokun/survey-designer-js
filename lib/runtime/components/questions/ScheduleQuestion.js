...
class ScheduleRow extends Component {
  render() {
    const { replacer, question, item, itemIndex, checkState, handleCheckBoxChange } = this.props;
    const label = item.getLabel();
    return (
      <tr className="color01">
        <td className="left" dangerouslySetInnerHTML={{ __html: replacer.name2Value(label) }} />
