...
export const InterviewRow = (props) => {
  ...
  const mobileContent = (!props.mobileTel.isDisable() && <label className="personalInfo-label">
    ...
    />
    <span id={`${props.question.getOutputName(FIELDS.interviewContactMobileTel)}__text`} className={classNames('select-tool check-not-text', { disabled: props.mobileTel.isOptional() })}>
  ...
  const homeContent = (!props.homeTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={interviewContactCheckboxGroup}
    />
    <span id={`${props.question.getOutputName(FIELDS.interviewContactHomeTel)}__text`} className={classNames('select-tool check-not-text', { disabled: props.homeTel.isOptional() })}>
  ...
  const workContent = (!props.workTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={interviewContactCheckboxGroup}
    />
    <span id={`${props.question.getOutputName(FIELDS.interviewContactWorkTel)}__text`} className={classNames('select-tool check-not-text', { disabled: props.workTel.isOptional() })}>
...
export const ScheduleRow = (props) => {
  ...
  const mobileContent = (!props.mobileTel.isDisable() && <label className="personalInfo-label">
    ...
    />
    <span id={`${props.question.getOutputName(FIELDS.scheduleContactMobileTel)}__text`} className={classNames('select-tool check-not-text', { disabled: props.mobileTel.isOptional() })}>
      {props.mobileTel.getLabel()}
    </span>
  </label>);
  ...
  const homeContent = (!props.homeTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={scheduleContactCheckboxGroup}
    />
    <span id={`${props.question.getOutputName(FIELDS.scheduleContactHomeTel)}__text`} className={classNames('select-tool check-not-text', { disabled: props.homeTel.isOptional() })}>
      {props.homeTel.getLabel()}
    </span>
  </label>);
  ...
  const workContent = (!props.workTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={scheduleContactCheckboxGroup}
    />
    <span id={`${props.question.getOutputName(FIELDS.scheduleContactWorkTel)}__text`} className={classNames('select-tool check-not-text', { disabled: props.workTel.isOptional() })}>
      {props.workTel.getLabel()}
    </span>
  </label>);
  ...
  const emailContent = (!props.email.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={scheduleContactCheckboxGroup}
    />
    <span id={`${props.question.getOutputName(FIELDS.scheduleContactEmail)}__text`} className={classNames('select-tool check-not-text', { disabled: props.email.isOptional() })}>
