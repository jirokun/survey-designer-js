...
function optionalLabel() {
  return <span className="question__personal-info__label_option">任意</span>;
}
...
export const AgeRow = (props) => {
  ...
  return (<tr>
    <td>
      {props.item.getLabel()}
      {props.item.isOptional() && optionalLabel()}
    </td>
    <td>
      <label>
        <input
          ...
          data-parsley-required={!props.item.isOptional()}
...
export const InterviewRow = (props) => {
  ...
  const mobileContent = (!props.mobileTel.isDisable() && <label className="personalInfo-label">
    ...
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.interviewContactMobileTel)} className={classNames('select-tool check-not-text', { disabled: props.mobileTel.isOptional() })}>
  ...
  const homeContent = (!props.homeTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={interviewContactCheckboxGroup}
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.interviewContactHomeTel)} className={classNames('select-tool check-not-text', { disabled: props.homeTel.isOptional() })}>
  ...
  const workContent = (!props.workTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      data-parsley-multiple={interviewContactCheckboxGroup}
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.interviewContactWorkTel)} className={classNames('select-tool check-not-text', { disabled: props.workTel.isOptional() })}>
...
export const ScheduleRow = (props) => {
  ...
  const mobileContent = (!props.mobileTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      disabled={props.mobileTel.isOptional()}
      type="checkbox"
      value="1"
    ...
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.scheduleContactMobileTel)} className={classNames('select-tool check-not-text', { disabled: props.mobileTel.isOptional() })}>
      {props.mobileTel.getLabel()}
    </span>
  </label>);
  ...
  const homeContent = (!props.homeTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      disabled={props.homeTel.isOptional()}
      type="checkbox"
      value="1"
      ...
      data-parsley-multiple={scheduleContactCheckboxGroup}
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.scheduleContactHomeTel)} className={classNames('select-tool check-not-text', { disabled: props.homeTel.isOptional() })}>
      {props.homeTel.getLabel()}
    </span>
  </label>);
  ...
  const workContent = (!props.workTel.isDisable() && <label className="personalInfo-label">
    <input
      ...
      disabled={props.workTel.isOptional()}
      type="checkbox"
      value="1"
      ...
      data-parsley-multiple={scheduleContactCheckboxGroup}
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.scheduleContactWorkTel)} className={classNames('select-tool check-not-text', { disabled: props.workTel.isOptional() })}>
      {props.workTel.getLabel()}
    </span>
  </label>);
  ...
  const emailContent = (!props.email.isDisable() && <label className="personalInfo-label">
    <input
      ...
      disabled={props.email.isOptional()}
      type="checkbox"
      value="1"
      ...
      data-parsley-multiple={scheduleContactCheckboxGroup}
    />
    <span id={props.question.getCheckboxLabelIdByPropName(FIELDS.scheduleContactEmail)} className={classNames('select-tool check-not-text', { disabled: props.email.isOptional() })}>
