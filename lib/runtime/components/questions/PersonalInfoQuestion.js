  ...
  generateRow(survey, question, item) {
    switch (item.getRowType()) {
      ...
      case 'InterviewPlaceRow':
        return <InterviewPlaceRow key={item.getId()} survey={survey} question={question} item={item} />;
      case 'InterviewMeansRow':
        return <InterviewMeansRow key={item.getId()} survey={survey} question={question} item={item} />;
      case 'InterviewRow':
        ...
        return (<InterviewRow
          ...
          question={question}
          item={item}
          homeTel={homeTelInInterview}
          mobileTel={mobileTelInInterview}
          workTel={workTelInInterview}
        />);
      case 'MobileTelRow':
      ...
      case 'ScheduleRow':
        ...
        return (<ScheduleRow
          ...
          question={question}
          item={item}
          homeTel={homeTelInSchedule}
          mobileTel={mobileTelInSchedule}
          workTel={workTelInSchedule}
          email={emailInSchedule}
        />);
      case 'SexRow':
