...
export default class PersonalInfoQuestion extends Component {
  ...
  handleHomeTelChange(value) {
    this.setState({ homeTelEmpty: S(value).isEmpty() });
  }
              ...
              <tr>
                ...
                <td>
                  <div id={`${question.getId()}_scheduleContactDiv`}>
                    ...
                    <label id={`${question.getId()}_scheduleContact_label`} className={`personalInfo-label ${homeTelEmpty ? 'personalInfo-label-disabled' : ''}`}>
                      <input
                        ...
                        data-parsley-required
                      />
                      <span id={`${question.getId()}_scheduleContact2__text`} className={`${homeTelEmpty ? 'disabled' : ''}`}>TEL（自宅）</span>
                    </label>
                    <label className="personalInfo-label">
                      <input
              ...
              <tr>
                ...
                <td>
                  <div id={`${question.getId()}_interviewContactDiv`}>
                    ...
                    <label id={`${question.getId()}_interviewContact_label`} className={`personalInfo-label ${homeTelEmpty ? 'personalInfo-label-disabled' : ''}`}>
                      <input
                        ...
                        data-parsley-required
                      />
                      <span id={`${question.getId()}_interviewContact2__text`} className={`${homeTelEmpty ? 'disabled' : ''}`}>TEL（自宅）</span>
                    </label>
                    <label className="personalInfo-label">
                      <input
