                ...
                <td>
                  <label>
                    <input
                      ...
                      data-dev-id={`${question.getDevId()}_${FIELDS.name}`}
                    />
                  </label>
                </td>
              </tr>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-dev-id={`${question.getDevId()}_${FIELDS.furigana}`}
                    />
                  </label>
                </td>
              </tr>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-parsley-required
                      data-dev-id={`${question.getDevId()}_${FIELDS.hospitalName}`}
                    />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <select
                    ...
                    data-parsley-required
                    data-dev-id={`${question.getDevId()}_${FIELDS.hospitalPrefecture}`}
                  >
                    <option value="">▽</option>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-parsley-required
                      data-dev-id={`${question.getDevId()}_${FIELDS.specialty}`}
                    />
                  </label>
                </td>
              </tr>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-dev-id={`${question.getDevId()}_${FIELDS.position}`}
                    />
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-dev-id={`${question.getDevId()}_${FIELDS.age}`}
                    />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <select
                    ...
                    data-parsley-required
                    data-dev-id={`${question.getDevId()}_${FIELDS.sex}`}
                  >
                    <option value="">▽</option>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-dev-id={`${question.getDevId()}_${FIELDS.mobileTel}`}
                    />
                  </label>
                </td>
              </tr>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-parsley-pattern="\(?\d+\)?\-?\d+\-?\d+"
                      data-parsley-pattern-message="正しい電話番号を入力してください"
                      data-dev-id={`${question.getDevId()}_${FIELDS.homeTel}`}
                    />
                    <span>※任意でご記入ください。</span>
                  </label>
                </td>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-parsley-pattern="\(?\d+\)?\-?\d+\-?\d+"
                      data-parsley-pattern-message="正しい電話番号を入力してください"
                      data-dev-id={`${question.getDevId()}_${FIELDS.workTel}`}
                    />
                  </label>
                </td>
              </tr>
                ...
                <td>
                  <label>
                    <input
                      ...
                      data-parsley-required
                      data-dev-id={`${question.getDevId()}_${FIELDS.email}`}
                    />
                  </label>
                </td>
              </tr>
                  ...
                  <div id={scheduleContactContainer}>
                    ...
                    <label className="personalInfo-label">
                      <input
                        ...
                        data-dev-id={`${question.getDevId()}_${FIELDS.scheduleContact1}`}
                      />
                      <span>携帯電話</span>
                    </label>
                    <label id={`${question.getId()}_scheduleContact_label`} className={classNames('personalInfo-label', { 'personalInfo-label-disabled': homeTelEmpty })}>
                      <input
                        ...
                        data-parsley-required
                        data-parsley-multiple={scheduleContactCheckboxGroup}
                        data-dev-id={`${question.getDevId()}_${FIELDS.scheduleContact2}`}
                      />
                    ...
                    <label className="personalInfo-label">
                      <input
                        ...
                        data-parsley-required
                        data-parsley-multiple={scheduleContactCheckboxGroup}
                        data-dev-id={`${question.getDevId()}_${FIELDS.scheduleContact3}`}
                      />
                      <span>TEL（勤務先）</span>
                    </label>
                    <label className="personalInfo-label">
                      <input
                        ...
                        data-parsley-required
                        data-parsley-multiple={scheduleContactCheckboxGroup}
                        data-dev-id={`${question.getDevId()}_${FIELDS.scheduleContact4}`}
                      />
                      <span>Eメール</span>
                    </label>
                  </div>
                  <div style={{ paddingTop: '1em' }}>
                    ...
                    <label>
                      <input
                        ...
                        data-parsley-required
                        data-dev-id={`${question.getDevId()}_${FIELDS.contactTimeWeekday}`}
                      />
                    </label>
                  </div>
                  <div style={{ paddingTop: '1em' }}>
                    ...
                    <label>
                      <input
                        ...
                        data-dev-id={`${question.getDevId()}_${FIELDS.contactTimeWeekend}`}
                      />
                      <span>※任意でご記入ください。</span>
                    </label>
                  </div>
                  ...
                  <div id={interviewContactContainer}>
                    ...
                    <label className="personalInfo-label">
                      <input
                        ...
                        data-dev-id={`${question.getDevId()}_${FIELDS.interviewContact1}`}
                      />
                      <span>携帯電話</span>
                    </label>
                    <label id={`${question.getId()}_interviewContact_label`} className={classNames('personalInfo-label', { 'personalInfo-label-disabled': homeTelEmpty })}>
                      <input
                        ...
                        data-parsley-required
                        data-parsley-multiple={interviewContactCheckboxGroup}
                        data-dev-id={`${question.getDevId()}_${FIELDS.interviewContact2}`}
                      />
                    ...
                    <label className="personalInfo-label">
                      <input
                        ...
                        data-parsley-required
                        data-parsley-multiple={interviewContactCheckboxGroup}
                        data-dev-id={`${question.getDevId()}_${FIELDS.interviewContact3}`}
                      />
                      <span>TEL（勤務先）</span>
                    </label>
                  </div>
