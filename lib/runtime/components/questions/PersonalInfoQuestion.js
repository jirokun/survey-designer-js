  ...
  render() {
    ...
    return (
      <div ref={(el) => { this.rootEl = el; }} className={this.constructor.name}>
        {S(title).isEmpty() ? null : <h2 className="question-title" dangerouslySetInnerHTML={{ __html: replaceUtil.name2Value(title, answers) }} />}
        {S(description).isEmpty() ?
          null : <h3 className="question-description" dangerouslySetInnerHTML={{ __html: replaceUtil.name2Value(description, answers) }} />}
          ...
          <table className="personalInfo question-form-grid-table">
            <tbody>
              <tr>
                ...
                <td>
                  <label>
                    <input type="text" name={question.getOutputName(FIELDS.name)} id={question.getOutputName(FIELDS.name)} data-parsley-required />
                  </label>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <label>
                    <input type="text" name={question.getOutputName(FIELDS.hospitalName)} id={question.getOutputName(FIELDS.hospitalName)} data-parsley-required />
                  </label>
                </td>
              </tr>
              <tr>
                <td>病院所在地</td>
                <td>
                  <select name={question.getOutputName(FIELDS.hospitalPrefecture)} id={question.getOutputName(FIELDS.hospitalPrefecture)} style={{ width: '10em' }} data-parsley-required>
                    <option value="">▽</option>
              ...
              <tr>
                ...
                <td>
                  <label>
                    <input type="text" name={question.getOutputName(FIELDS.specialty)} id={question.getOutputName(FIELDS.specialty)} data-parsley-required />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <label>
                    <input type="text" name={question.getOutputName(FIELDS.position)} id={question.getOutputName(FIELDS.position)} />
              ...
              <tr>
                ...
                <td>
                  <label>
                    <input type="number" name={question.getOutputName(FIELDS.age)} id={question.getOutputName(FIELDS.age)} style={{ width: '5em' }} data-parsley-required />
                  </label>
                </td>
              </tr>
              <tr>
                <td>性別</td>
                <td>
                  <select name={question.getOutputName(FIELDS.sex)} id={question.getOutputName(FIELDS.sex)} style={{ width: '10em' }} data-parsley-required>
                    <option value="">▽</option>
              ...
              <tr>
                ...
                <td>
                  <label>
                    <input type="text" name={question.getOutputName(FIELDS.workTel)} id={question.getOutputName(FIELDS.workTel)} data-parsley-required />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <label>
                    <input type="email" name={question.getOutputName(FIELDS.email)} id={question.getOutputName(FIELDS.email)} data-parsley-required />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div id={scheduleContactContainer}>
                    ...
                    <label id={`${question.getId()}_scheduleContact_label`} className={classNames('personalInfo-label', { 'personalInfo-label-disabled': homeTelEmpty })}>
                      <input
                        ...
                        data-parsley-multiple={scheduleContactCheckboxGroup}
                      />
                      <span id={`${question.getId()}_scheduleContact2__text`} className={classNames({ disabled: homeTelEmpty })}>TEL（自宅）</span>
                    </label>
                    <label className="personalInfo-label">
                      <input
                  ...
                  <div style={{ paddingTop: '1em' }}>
                    ご連絡のつきやすい時間帯（平日）<br />
                    <label>
                      <input type="text" name={question.getOutputName(FIELDS.contactTimeWeekday)} id={question.getOutputName(FIELDS.contactTimeWeekday)} data-parsley-required />
                    </label>
                  </div>
                  <div style={{ paddingTop: '1em' }}>
                    ご連絡のつきやすい時間帯（休日）<br />
                    <label>
                      <input type="text" name={question.getOutputName(FIELDS.contactTimeWeekend)} id={question.getOutputName(FIELDS.contactTimeWeekend)} />
                      <span>※任意でご記入ください。</span>
                    </label>
                  </div>
                </td>
                  ...
                  <div id={interviewContactContainer}>
                    ...
                    <label id={`${question.getId()}_interviewContact_label`} className={classNames('personalInfo-label', { 'personalInfo-label-disabled': homeTelEmpty })}>
                      <input
                        ...
                        data-parsley-multiple={interviewContactCheckboxGroup}
                      />
                      <span id={`${question.getId()}_interviewContact2__text`} className={classNames({ disabled: homeTelEmpty })}>TEL（自宅）</span>
                    </label>
                    <label className="personalInfo-label">
                      <input
