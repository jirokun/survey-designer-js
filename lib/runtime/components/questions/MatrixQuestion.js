                ...
                {subItems.map((subItem) => {
                  ...
                  return (
                    <td key={subItem.getId()} id={subItem.getId()} className={columnClassName} data-col-order={subItem.getIndex() + 1}>
                      ...
                      {
                        question.isMatrixReverse() ? <div id={this.getLabelId(subItem)} className={divClassName} dangerouslySetInnerHTML={{ __html: replacer.id2Span(subItem.getLabel()) }} /> :
                        <div className={divClassName} dangerouslySetInnerHTML={{ __html: replacer.id2Span(subItem.getLabel()) }} />
                      }
                    </td>
                  );
                })}
