...
class Page extends Component {
  ...
  initializePageComponent() {
    ...
    this.imagePopup = new ImagePopup(this.pageEl).initialize();
    this.numberValidation = new NumberValidation(this.pageEl, survey, page, runtime).initialize();
    if (!options.isShowDetail()) this.reprint = new Reprint(this.pageEl, survey, page, runtime).initialize();
  }
