...
import { showOutputNo, findEnabledFormElement, setDevId, showDevId, isDevelopment } from '../../utils';
...
class Page extends Component {
  ...
  componentDidMount() {
    const { options, doNotTransition, survey } = this.props;
    const pageEl = ReactDOM.findDOMNode(this);
    setDevId(this.pageEl, survey); // dev-id を各要素セット
    ...
    if (options.isShowOutputNo() && !isDevelopment()) showOutputNo(pageEl);
