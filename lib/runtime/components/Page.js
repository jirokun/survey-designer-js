...
class Page extends Component {
  ...
  // JavaScriptを評価する
  evaluateJavaScript() {
    const { survey, page, runtime, doNotExecuteJavaScript, changeCurrentPageAnswers } = this.props;
    ...
    try {
      new Function('$', 'document', 'pageManager', 'surveyManager', javaScriptCode)($, ownerDoc, this.pageManager, this.surveyManager);
