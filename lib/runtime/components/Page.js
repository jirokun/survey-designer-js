...
import TextQuestionJS from './plain/TextQuestionJS';
import SingleTextQuestionJS from './plain/SingleTextQuestionJS';
import PersonalQuestionJS from '../components/plain/PersonalQuestionJS';
...
export default class Page extends Component {
  ...
  convertCheckboxAndRadio() {
    if (this.props.showOnlyTable) return;
  ...
  initializePageComponent(SurveyJS) {
    ...
    (this.plainComponents.PersonalQuestionJS = new PersonalQuestionJS(pageEl, page)).initialize();
    // setValueなどで動作することがあるのでnumberValidationは最後に登録する
    (this.plainComponents.numberValidation = new NumberValidation(pageEl, survey, page, runtime)).initialize();
    (this.plainComponents.textQuestionJS = new TextQuestionJS(pageEl, survey, page, runtime)).initialize();
    (this.plainComponents.singleTextQuestionJS = new SingleTextQuestionJS(pageEl, survey, page, runtime)).initialize();
  }
