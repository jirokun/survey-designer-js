...
class Page extends Component {
  ...
  handleClickNext() {
    const { answers, survey, page, submitPage, noTransition, showEditModeMessage } = this.props;
  ...
  createQuestions() {
    ...
    return page.questions.map((q, index) => {
      ...
      const props = { id: key, question: q, page, replacer: survey.createReplacer(runtime.getAnswers().toJS()) };
