...
class Page extends Component {
  ...
  handleClickNext() {
    ...
    this.surveyManager.answers = mergedAnswers;
  ...
  evaluateJavaScript() {
    ...
    try {
      new Function('$', 'document', 'pageManager', 'sm', javaScriptCode)($, ownerDoc, this.pageManager, this.surveyManager);
      const answers = runtime.getAnswers().toJS();
      this.surveyManager.answers = answers;
