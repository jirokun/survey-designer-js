...
class MatrixTableEditorPart extends Component {
  ...
  initTinyMCE() {
    ...
    tinymce.init({
      ...
      body_id: 'content',
      extended_valid_elements: 'span[class=]', // 指定しないと空のspanタグが消させれてしまう
...
<div class="questionsEditBox">
  <div class="questionsBox">
    <div class="questionBox">
      ${ReactDOMServer.renderToStaticMarkup(<MatrixQuestion showOnlyTable replacer={replacer} {...this.props} />)}
    </div>
  </div>
</div>`;
          editor.setContent(pageHtml);
        });
      },
    });
  }
