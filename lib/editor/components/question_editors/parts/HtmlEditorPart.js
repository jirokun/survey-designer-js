...
class HtmlEditorPart extends Component {
  ...
  render() {
    const { runtime, survey, options, content } = this.props;
    const toolbar = this.props.toolbar || 'bold italic underline strikethrough forecolor backcolor removeformat table link unlink fullscreen code reference_answer image_manager';
      ...
      return (
        <TinyMCE
          ...
          config={{
            menubar: '',
            toolbar,
            plugins: 'table contextmenu textcolor paste fullscreen link code reference_answer image_manager',
            inline: true,
            statusbar: false,
            target_list: false,
