    ...
    if (this.state.tinymceVisible) {
      return (
        <TinyMCE
          ...
          config={{
            menubar: '',
            toolbar: 'bold italic underline strikethrough backcolor forecolor anchor removeformat reference_answer image_manager',
            plugins: 'contextmenu textcolor paste link reference_answer image_manager',
