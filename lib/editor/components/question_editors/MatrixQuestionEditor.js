...
export default function MatrixQuestionEditor(props) {
  ...
  */
  const createsUnitLabel = matrixReverse && question.getMatrixType() === 'number';
  const subCreatesUnitLabel = !matrixReverse && question.getMatrixType() === 'number';
  return (
    <BaseQuestionEditor
      page={page}
      question={question}
      ...
      subCreatesUnitLabel={subCreatesUnitLabel}
    />
  );
}
