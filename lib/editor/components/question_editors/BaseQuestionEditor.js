        ...
        { item ?
          <FormGroup>
            <div className="col-md-2 control-label">
              ...
              { !hideOptionalItemFunction && <div className={classNames({ invisible: disabled || question.isMatrixHtmlEnabled() })}>
                <OverlayTrigger
...
>>>>>>> Fix variable name & recover disabled
                  </tbody>
                </table>
              </div>
            </Col>
