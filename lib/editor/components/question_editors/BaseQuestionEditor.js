...
class BaseQuestionEditor extends Component {
  ...
  getTableHeader(question, items, createsUnitLabel, itemAdditionalInput, itemExclusive, optionalItem) {
            ...
            <Col md={10}>
              <div className="item-editor">
                <table className="item-editor-table">
                  {this.getTableHeader(question, items, createsUnitLabel, itemAdditionalInput, itemExclusive, optionalItem)}
                  <tbody>
