...
import { Col, FormGroup, ControlLabel, Radio, Checkbox, FormControl, InputGroup } from 'react-bootstrap';
...
class BaseQuestionEditor extends Component {
        ...
        { random || showTotal ?
          <FormGroup>
            ...
            <Col md={10}>
              ...
              { matrixReverse ?
                <Checkbox checked={question.isMatrixReverse()} onChange={e => this.handleChangeQuestionAttribute('matrixReverse', e.target.checked)}>{matrixReverse === true ? '行列を入れ替える' : matrixReverse}</Checkbox> : null }
            </Col>
          </FormGroup> : null }
        { item ?
          <FormGroup>
  ...
  createValidationEditor() {
    ...
    const ru = survey.createReplaceUtil(runtime.getAnswers());
      ...
      <form ref={(el) => { this.formEl = el; }}>
        ...
        { min ?
          <FormGroup>
            ...
            <Col md={10}>
              <FormControl componentClass="input" value={ru.name2OutputNo(question.getMin())} onChange={e => this.handleChangeQuestionAttribute('min', e.target.value)} />
            </Col>
          </FormGroup> : null }
        { max ?
          <FormGroup>
            ...
            <Col md={10}>
              <FormControl componentClass="input" value={ru.name2OutputNo(question.getMax())} onChange={e => this.handleChangeQuestionAttribute('max', e.target.value)} />
            </Col>
          </FormGroup> : null }
        { totalEqualTo && question.isShowTotal() ?
          <FormGroup>
            ...
            <Col md={10}>
              <FormGroup>
                <InputGroup>
                  <FormControl type="text" value={ru.name2OutputNo(question.getTotalEqualTo())} onChange={e => this.handleChangeQuestionAttribute('totalEqualTo', e.target.value)} />
