        ...
        { random || showTotal ?
          <FormGroup>
            ...
            <Col md={10}>
              ...
              { matrixTategakiCols ?
                <Checkbox checked={question.isMatrixTategakiCols()} onChange={e => this.handleChangeQuestionAttribute('matrixTategakiCols', e.target.checked)}>{matrixTategakiCols === true ? '列ヘッダを縦書き' : matrixTategakiCols}</Checkbox> : null }
            </Col>
          </FormGroup> : null }
        { item ?
          <FormGroup>
