      ...
      <div>
        ...
        { description ?
          <FormGroup>
            ...
            <Col md={10}><QuestionHtmlEditorPart
      ...
      <form ref={(el) => { this.formEl = el; }}>
        ...
        { min ?
          <FormGroup>
            ...
            <Col md={10}>
              <ValueEditorPart page={page} question={question} value={question.getMin()} onChange={value => this.handleChangeQuestionAttribute('min', value)} />
            </Col>
          </FormGroup> : null }
        { max ?
          <FormGroup>
            ...
            <Col md={10}>
              <ValueEditorPart page={page} question={question} value={question.getMax()} onChange={value => this.handleChangeQuestionAttribute('max', value)} />
            </Col>
          </FormGroup> : null }
        { totalEqualTo && question.isShowTotal() ?
          <FormGroup>
            ...
            <Col md={10}>
              <FormGroup>
                <InputGroup>
                  <ValueEditorPart page={page} question={question} value={question.getTotalEqualTo()} onChange={value => this.handleChangeQuestionAttribute('totalEqualTo', value)} />
