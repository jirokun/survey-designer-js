...
class Menu extends Component {
  ...
  createDevelopemtnMenu() {
    ...
    return (
      <NavDropdown className="menu-preview" eventKey={1} title="開発モードメニュー" id="basic-nav-dropdown">
        <MenuItem eventKey={1.1} href={dataStr} download={fileName}>定義の保存</MenuItem>
      </NavDropdown>
    );
  }
