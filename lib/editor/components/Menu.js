        ...
        <Nav pullRight>
          ...
          <NavDropdown eventKey={1} title="表示" id="basic-nav-dropdown">
            <MenuItem
              eventKey={1.1}
              href="#"
              onClick={() => changeShowPane('graphPane', !viewSetting.getGraphPane())}
            >
              <Glyphicon glyph="ok" className={classNames({ invisible: !viewSetting.getGraphPane() })} /> ページ一覧
            </MenuItem>
            <MenuItem
              eventKey={1.2}
              href="#"
            ...
            >
              <Glyphicon glyph="ok" className={classNames({ invisible: !viewSetting.getEditorPane() })} /> デザインビュー
            </MenuItem>
            <MenuItem
              eventKey={1.3}
              href="#"
            ...
            >
              <Glyphicon glyph="ok" className={classNames({ invisible: !viewSetting.getPreviewPane() })} /> プレビュー
            </MenuItem>
          </NavDropdown>
