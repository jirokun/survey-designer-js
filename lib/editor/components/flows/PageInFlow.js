  ...
  createQuestionPopover() {
    ...
    return (
      <Popover id="popover-positioned-right" title="ページへのアイテム追加">
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('Checkbox', pageId, popoverIndex)} block>複数選択肢</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('Radio', pageId, popoverIndex)} block>単一選択肢</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('MultiNumber', pageId, popoverIndex)} block>数値記入</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('SingleText', pageId, popoverIndex)} block>1行テキスト</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('Text', pageId, popoverIndex)} block>複数行テキスト</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('Matrix', pageId, popoverIndex)} block>表形式</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('Description', pageId, popoverIndex)} block>説明文</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('ScreeningAgreement', pageId, popoverIndex)} block>調査許諾</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('Schedule', pageId, popoverIndex)} block>日程</Button>
        <Button bsSize="small" bsStyle="default" onClick={() => addQuestion('PersonalInfo', pageId, popoverIndex)} block>個人情報</Button>
      </Popover>
    );
  }
