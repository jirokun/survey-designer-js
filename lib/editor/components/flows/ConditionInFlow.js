...
class ConditionInFlowOrig extends Component {
  /** conditionのli要素に対応するIDを返す。 */
  static getConditionLiId(condition) {
    return `condition_in_flow_${condition.getId()}`;
  }
  ...
  render() {
    ...
    return connectDragPreview(connectDropTarget(
      <li id={ConditionInFlowOrig.getConditionLiId(condition)} className={classNames('condition', { invisible: dragging })}>
