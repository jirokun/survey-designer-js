...
class NodeInFlowOrig extends Component {
  ...
  render() {
    ...
    return connectDragPreview(connectDropTarget(
      <div className={classNames(node.getType(), { invisible: dragging, selected: focusThisNode }, 'enq-page')} onClick={() => this.onNodeSelect(node)}>
...
const actionsToProps = dispatch => ({
  selectNode: nodeId => dispatch(RuntimeActions.selectNode(nodeId)),
