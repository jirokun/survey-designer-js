  ...
  constructor() {
    ...
    this.addQuestionPopover = (
      <Popover id="popover-positioned-right" title="ページへのアイテム追加">
        ...
        <Button bsSize="small" bsStyle="info" onClick={() => this.handleAddQuestion('Schedule')} block>日程</Button>
        <Button bsSize="small" bsStyle="info" onClick={() => this.handleAddQuestion('PersonalInfo')} block>個人情報</Button>
      </Popover>
    );
  }
