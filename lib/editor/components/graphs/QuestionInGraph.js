...
class QuestionInGraphOrig extends Component {
  ...
  /** 描画 */
  render() {
    const { state, page, question, connectDragPreview, connectDragSource, connectDropTarget, isDragging } = this.props;
    ...
    return connectDragPreview(connectDropTarget(
      <li className="question" style={{ opacity }}>
...
const conditionTarget = {
  hover(props, monitor, component) {
    ...
    // 下向きのドラッグ処理
    if (dragQuestionIndex < hoverQuestionIndex && hoverClientY < hoverMiddleY) return;
