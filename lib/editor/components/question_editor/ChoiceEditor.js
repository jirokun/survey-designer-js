...
import ChoiceDefinition from '../../../runtime/models/definitions/questions/ChoiceDefinition';
...
class ChoiceEditor extends Component {
  ...
  renderChoiceEditorRow(choice, index, choices) {
    ...
    const exclusiveEl = exclusive ?
      <td className="option"><input type="checkbox" className="exclusive" onChange={() => this.handleChangeOption()} checked={choice.isExclusive()} /></td> : null;
