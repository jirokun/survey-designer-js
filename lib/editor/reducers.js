...
function pageReducer(survey, action, replacer) {
  switch (action.type) {
    ...
    case C.CHANGE_ITEM_VISIBILITY_CONDITIONS:
      return survey.updateIn(pageSelector(survey, action), page =>
        page.updateItemVisiblityConditions(survey, action.questionId, action.value, replacer));
    case C.CHANGE_SUB_ITEM_VISIBILITY_CONDITIONS:
      return survey.updateIn(pageSelector(survey, action), page =>
        page.updateSubItemVisiblityConditions(survey, action.questionId, action.value, replacer));
