...
export function swapQuestion(srcNodeId, srcQuestionId, destNodeId, destQuestionId) {
  return { type: C.SWAP_QUESTION, srcNodeId, srcQuestionId, destNodeId, destQuestionId };
}
