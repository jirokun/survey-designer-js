...
export function changeLogicVariable(pageId, logicVariableId, logicVariable) {
  return { type: C.CHANGE_LOGIC_VARIABLE, pageId, logicVariableId, logicVariable };
}
...
export function addLogicVariable(pageId) {
  return { type: C.ADD_LOGIC_VARIABLE, pageId };
}
...
export function removeLogicVariable(pageId, logicVariableId) {
  return { type: C.REMOVE_LOGIC_VARIABLE, pageId, logicVariableId };
}
