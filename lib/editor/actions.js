...
export function changeItemVisibilityConditions(questionId, value) {
  return { type: C.CHANGE_ITEM_VISIBILITY_CONDITIONS, questionId, value };
}
export function changeSubItemVisibilityConditions(questionId, value) {
  return { type: C.CHANGE_SUB_ITEM_VISIBILITY_CONDITIONS, questionId, value };
}
