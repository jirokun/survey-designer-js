...
export function saveAllJSCodeAndSavedAt(dispatch, allJavaScriptCode, savedAt) {
  dispatch(saveAllJavaScript(allJavaScriptCode));
  dispatch(saveSavedAtOnAllJavaScript(savedAt));
}
