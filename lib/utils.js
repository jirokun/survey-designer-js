...
/** containerEl内にある表示されているフォームエレメントを取得する */
export function findVisibleFormElement(containerEl) {
  return $(containerEl).find('input:visible,select:visible,textarea:visible');
}
